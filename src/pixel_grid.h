 ...
 * Squared
 */
const uint32_t PROGMEM squared_lut[][16] = {
  { 0x000000,0x000000,0x000000,0x000000,
...
#define LEN_SQUARED_SEQ  (sizeof(squared_lut) / sizeof(squared_lut[0]))                 //Number of rows/frames
#define REPS_SQUARED_SEQ     4
#define SQUARED_FRAMERATE    5
